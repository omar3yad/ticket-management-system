    ...
    <div class="column column-80">
        <div class="notes view content">
            ...
            <table>
                <tr>
                    <th><?= __('Ticket') ?></th>
                    <td><?= $note->hasValue('ticket') ? $this->Html->link($note->ticket->subject, ['controller' => 'Tickets', 'action' => 'view', $note->ticket->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
            ...
            <div class="text">
                <strong><?= __('Note Text') ?></strong>
                <blockquote>
                    <?= $this->Text->autoParagraph(h($note->note_text)); ?>
                </blockquote>
            </div>
        </div>
    </div>
